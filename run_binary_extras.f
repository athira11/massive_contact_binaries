...
! *********************************************************************** 
      ...
      integer function extras_binary_startup(binary_id,restart,ierr)
         ...
         if (.not. restart) then
            ...
            b% s1% lxtra17 = .false. ! Terminated due to mass transfer in q<=0.15 system
      ...
      integer function extras_binary_finish_step(binary_id)
         ...
         if (.not. b% ignore_rlof) then
            ...
            if (b% rl_relative_gap(1) > -1d-2 .and. b% m2 / b% m1 < 0.151) then
               extras_binary_finish_step = terminate
               write(*,*) "Terminated due to mass transfer in q_i<=0.15 system"
               b% s1% lxtra17 = .true.
      ...
      subroutine extras_binary_after_evolve(binary_id, ierr)
         ...
         if (b% s1% lxtra17) &
            write(iounit,*) "Terminated due to mass transfer in q_i<=0.15 system"
         if (b% s1% lxtra20) &
